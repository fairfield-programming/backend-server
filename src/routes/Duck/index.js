module.exports = (req, res) => {
    ...
    var color = req.query.color || "#F7D23D";
    var beakColor = req.query.beakColor || "#E05050";
    var smoke = req.query.smoke || 0;
    var eyes = req.query.eyes || '1';

    // Add Duck Background
    var output = [
        `<path d="M108.269 63.2162C88.5016 65.824 90.5809 82.7746 94.0914 90.924C91.7961 89.7016 86.3142 86.8493 82.7497 85.2194C78.294 83.1821 71.813 85.6269 70.5978 86.4419C69.3826 87.2568 65.332 96.6285 67.7624 111.705C70.1927 126.781 81.5345 132.486 88.4206 135.338C95.3066 138.19 110.699 137.783 122.041 130.856C133.383 123.929 132.167 111.297 128.117 106.815C124.876 103.229 124.336 96.3569 124.471 93.3688C127.307 82.2314 128.036 60.6085 108.269 63.2162Z" fill="${color}" stroke="black"/>`,
    ];
    ...
    // Add Wing
    output.push(`<path d="M85.8869 107.197C99.2754 105.536 100.718 113.707 99.7652 118L76.4987 115.507C71.6004 100.965 80.1723 98.8878 81.3969 102.627C82.3765 105.619 84.7984 106.92 85.8869 107.197Z" fill="${color}"/>`);
    ...
    res.send(`<svg width="200" height="200" viewBox="0 0 200 200" fill="none" xmlns="http://www.w3.org/2000/svg">\n${output.join("\n")}\n</svg>`);
